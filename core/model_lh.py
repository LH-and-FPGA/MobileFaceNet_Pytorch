...
if __name__ == "__main__":
    ...
    net_orig = MobileFacenet(Mobilefacenet_bottleneck_setting, mid_channels=512)
    total_orig = sum(p.numel() for p in net_orig.parameters())
    ...
    net_tiny = MobileFacenet()  # uses Mobilefacenet_tiny_setting + mid_channels=128 by default
